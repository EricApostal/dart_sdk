...
class _PacksApi implements PacksApi {
  _PacksApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<PackDashboardResponse> listUserPacks() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PackDashboardResponse>(
  ...
  @override
  Future<List<GuildEmojiWithUserResponse>> listPackEmojis({
    required String packId,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  @override
  Future<List<GuildStickerWithUserResponse>> listPackStickers({
    required String packId,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
  ...
  Future<GuildStickerResponse> updatePackSticker({
    ...
    final _options = _setStreamType<GuildStickerResponse>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/packs/stickers/${packId}/${stickerId}',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
  ...
  Future<PackSummaryResponse> updatePack({
    required String packId,
    required PackUpdateRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<PackSummaryResponse>(
      Options(method: 'PATCH', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/packs/${packId}',
  ...
  @override
  Future<void> installPack({required String packId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> uninstallPack({required String packId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<PackSummaryResponse> createPack({
    ...
    required PackCreateRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
