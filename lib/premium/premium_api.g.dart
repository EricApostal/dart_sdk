...
class _PremiumApi implements PremiumApi {
  _PremiumApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<UrlResponse> createCustomerPortal() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> rejoinOperatorGuild() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<PriceIdsResponse> getPriceIds({String? countryCode}) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PriceIdsResponse>(
  ...
  @override
  Future<void> rejoinVisionaryGuild() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
