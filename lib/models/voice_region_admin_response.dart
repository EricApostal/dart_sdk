...
part 'voice_region_admin_response.mapper.dart';

@MappableClass()
class VoiceRegionAdminResponse with VoiceRegionAdminResponseMappable {
  ...
  static VoiceRegionAdminResponse fromJson(Map<String, dynamic> json) =>
      VoiceRegionAdminResponseMapper.fromJson(json);
}
