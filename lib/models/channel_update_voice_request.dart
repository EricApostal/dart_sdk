...
part 'channel_update_voice_request.mapper.dart';

@MappableClass()
class ChannelUpdateVoiceRequest with ChannelUpdateVoiceRequestMappable {
  ...
  static ChannelUpdateVoiceRequest fromJson(Map<String, dynamic> json) =>
      ChannelUpdateVoiceRequestMapper.fromJson(json);
}
