...
part 'pack_dashboard_response_sticker.mapper.dart';

@MappableClass()
class PackDashboardResponseSticker with PackDashboardResponseStickerMappable {
  const PackDashboardResponseSticker({
  ...
  static PackDashboardResponseSticker fromJson(Map<String, dynamic> json) =>
      PackDashboardResponseStickerMapper.fromJson(json);
}
