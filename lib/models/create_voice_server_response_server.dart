...
part 'create_voice_server_response_server.mapper.dart';

@MappableClass()
class CreateVoiceServerResponseServer
    with CreateVoiceServerResponseServerMappable {
  const CreateVoiceServerResponseServer({
  ...
  static CreateVoiceServerResponseServer fromJson(Map<String, dynamic> json) =>
      CreateVoiceServerResponseServerMapper.fromJson(json);
}
