...
part 'create_voice_region_response_region.mapper.dart';

@MappableClass()
class CreateVoiceRegionResponseRegion
    with CreateVoiceRegionResponseRegionMappable {
  const CreateVoiceRegionResponseRegion({
    required this.id,
    required this.name,
    required this.emoji,
  ...
  static CreateVoiceRegionResponseRegion fromJson(Map<String, dynamic> json) =>
      CreateVoiceRegionResponseRegionMapper.fromJson(json);
}
