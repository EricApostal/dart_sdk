...
part 'message_search_results_response_messages_type_type.mapper.dart';

/// The type of message
@MappableEnum(defaultValue: 'unknown')
enum MessageSearchResultsResponseMessagesTypeType {
  ...
  get $valuesDefined => values
      .where(
        (value) =>
            value != MessageSearchResultsResponseMessagesTypeType.unknown,
      )
      .toList();
}
