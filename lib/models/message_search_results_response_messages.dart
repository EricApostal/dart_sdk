...
part 'message_search_results_response_messages.mapper.dart';

@MappableClass()
class MessageSearchResultsResponseMessages
    with MessageSearchResultsResponseMessagesMappable {
  ...
  final MessageSearchResultsResponseMessagesTypeType type;
  ...
  ) => MessageSearchResultsResponseMessagesMapper.fromJson(json);
}
