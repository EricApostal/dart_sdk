...
part 'channel_update_link_request.mapper.dart';

@MappableClass()
class ChannelUpdateLinkRequest with ChannelUpdateLinkRequestMappable {
  const ChannelUpdateLinkRequest({
    required this.type,
    this.topic,
    this.url,
    this.parentId,
  ...
  static ChannelUpdateLinkRequest fromJson(Map<String, dynamic> json) =>
      ChannelUpdateLinkRequestMapper.fromJson(json);
}
