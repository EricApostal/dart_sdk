...
class LoginRequestMapper extends ClassMapperBase<LoginRequest> {
  ...
  static String? _$inviteCode(LoginRequest v) => v.inviteCode;
  static const Field<LoginRequest, String> _f$inviteCode = Field(
    'inviteCode',
    _$inviteCode,
    key: r'invite_code',
    opt: true,
...
abstract class LoginRequestCopyWith<$R, $In extends LoginRequest, $Out>
  ...
  $R call({String? email, String? password, String? inviteCode});
...
class _LoginRequestCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({String? email, String? password, Object? inviteCode = $none}) =>
      $apply(
        FieldCopyWithData({
