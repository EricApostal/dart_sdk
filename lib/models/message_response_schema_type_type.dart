...
part 'message_response_schema_type_type.mapper.dart';
...
enum MessageResponseSchemaTypeType {
  ...
  static List<MessageResponseSchemaTypeType> get $valuesDefined => values
      .where((value) => value != MessageResponseSchemaTypeType.unknown)
      .toList();
}
