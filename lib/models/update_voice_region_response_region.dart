...
part 'update_voice_region_response_region.mapper.dart';

@MappableClass()
class UpdateVoiceRegionResponseRegion
    with UpdateVoiceRegionResponseRegionMappable {
  ...
  static UpdateVoiceRegionResponseRegion fromJson(Map<String, dynamic> json) =>
      UpdateVoiceRegionResponseRegionMapper.fromJson(json);
}
