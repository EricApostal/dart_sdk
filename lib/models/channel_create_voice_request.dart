...
part 'channel_create_voice_request.mapper.dart';

@MappableClass()
class ChannelCreateVoiceRequest with ChannelCreateVoiceRequestMappable {
  const ChannelCreateVoiceRequest({
    required this.type,
    required this.name,
    this.topic,
    this.url,
  ...
  static ChannelCreateVoiceRequest fromJson(Map<String, dynamic> json) =>
      ChannelCreateVoiceRequestMapper.fromJson(json);
}
