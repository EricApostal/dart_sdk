...
part 'guild_invite_metadata_response_guild.mapper.dart';

@MappableClass()
class GuildInviteMetadataResponseGuild
    with GuildInviteMetadataResponseGuildMappable {
  ...
  static GuildInviteMetadataResponseGuild fromJson(Map<String, dynamic> json) =>
      GuildInviteMetadataResponseGuildMapper.fromJson(json);
}
