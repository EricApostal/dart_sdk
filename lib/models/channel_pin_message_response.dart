...
part 'channel_pin_message_response.mapper.dart';

/// The pinned message
@MappableClass()
class ChannelPinMessageResponse with ChannelPinMessageResponseMappable {
  ...
  static ChannelPinMessageResponse fromJson(Map<String, dynamic> json) =>
      ChannelPinMessageResponseMapper.fromJson(json);
}
