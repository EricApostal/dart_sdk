...
class _DonationsApi implements DonationsApi {
  ...
  Future<DonationCheckoutResponse> createDonationCheckout({
    required DonationCheckoutRequest body,
  }) async {
    ...
    final _options = _setStreamType<DonationCheckoutResponse>(
  ...
  @override
  Future<void> manageDonation({required String token}) async {
    final _extra = <String, dynamic>{};
  ...
  Future<void> requestDonationMagicLink({
    required DonationRequestLinkRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
