...
class _ConnectionsApi implements ConnectionsApi {
  _ConnectionsApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<ConnectionResponse>> listConnections() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ConnectionResponse>>(
    ...
    late List<ConnectionResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                ConnectionResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<ConnectionVerificationResponse> initiateConnection({
    required CreateConnectionRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    ...
    final _options = _setStreamType<ConnectionVerificationResponse>(
  ...
  Future<BlueskyAuthorizeResponse> authorizeBlueskyConnection({
    required BlueskyAuthorizeRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<BlueskyAuthorizeResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  Future<void> reorderConnections({
    required ReorderConnectionsRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<ConnectionResponse> verifyAndCreateConnection({
    required VerifyAndCreateConnectionRequest body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
