...
class _DiscoveryApi implements DiscoveryApi {
  _DiscoveryApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<DiscoveryCategoryResponse>> listDiscoveryCategories() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<DiscoveryCategoryResponse>>(
    ...
    late List<DiscoveryCategoryResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                DiscoveryCategoryResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<DiscoveryGuildListResponse> searchDiscoveryGuilds({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DiscoveryGuildListResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/discovery/guilds',
  ...
  Future<DiscoveryStatusResponse> getDiscoveryStatus({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DiscoveryStatusResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/guilds/${guildId}/discovery',
