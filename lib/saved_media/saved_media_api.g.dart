...
class _SavedMediaApi implements SavedMediaApi {
  _SavedMediaApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<List<FavoriteMemeResponse>> listFavoriteMemes() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<FavoriteMemeResponse>>(
    ...
    late List<FavoriteMemeResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                FavoriteMemeResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
  ...
  Future<FavoriteMemeResponse> createMemeFromUrl({
    required CreateFavoriteMemeFromUrlBodySchema body,
  }) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
